...
def params():
    ...
    add_arg("--train", default=False, help="Whether train the model",type=str2bool)
    ...
    add_arg("--map_file", default=os.path.join(root_path+"data_new","maps.pkl"), help="file for maps",type=str)
    add_arg("--data_proc_file", default=os.path.join(root_path+"data_new","data_new_proc.pkl"), help="file for processed data_new",type=str)
    add_arg("--emb_file", default=os.path.join(root_path+"data_new", "vec.txt"), help="Path for pre_trained embedding",type=str)
    
    add_arg("--train_file", default=os.path.join(root_path+"data_new", "example_new.train"), help="Path for train data_new",type=str)
    add_arg("--dev_file", default=os.path.join(root_path+"data_new", "example_new.dev"), help="Path for dev data_new",type=str)
    add_arg("--test_file", default=os.path.join(root_path+"data_new", "example_new.test"), help="Path for test data_new",type=str)
